...
def main():
    setup_logger()
    e1 = dict(cycles=1, step=1, samples=134, reps=80, velocity=4, acceleration=4, deceleration=4)
    ...
    experimentos = [e1]
    time.sleep(3600)  # tiempo de espera en segundos
    basename = "phase-diff-with-quartz"  # with-quartz y guardar!
