...
def add_to_subparsers(subparsers):
    ...
    p.add_argument('-n-ch0', '--n_harmonics_ch0', type=int, default=1, help=HELP_NHARMONICS_CH0)
    p.add_argument('-n-ch1', '--n_harmonics_ch1', type=int, default=1, help=HELP_NHARMONICS_CH1)
