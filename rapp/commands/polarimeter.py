...
def add_to_subparsers(subparsers):
    ...
    g.add_argument('--acceleration', type=float, default=8, metavar='', help=HELP_ACCELERATION)
    g.add_argument('--deceleration', type=float, default=8, metavar='', help=HELP_DECELERATION)
