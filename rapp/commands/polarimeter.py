...
HELP_ENABLE_PM100 = 'enables the PM100 normalization detector. (default: %(default)s).'
# HELP_ENABLE_HWP = 'enables the HW plate in rotary stage. (default: %(default)s).'
...
def add_to_subparsers(subparsers):
    ...
    p.add_argument('--enable-pm100', action='store_true', help=HELP_ENABLE_PM100)
    ...
    g.add_argument('--hwp', action='store_true', help=HELP_HWP, dest='hwp_enabled')
